...
ConstraintType LearntConstraint::type() const { return Constraint_t::Conflict; }
/////////////////////////////////////////////////////////////////////////////////////////
// PostPropagator
/////////////////////////////////////////////////////////////////////////////////////////
...
bool Antecedent::checkPlatformAssumptions() {
	...
	Antecedent a(max);
	if (a.type() != Antecedent::Binary || a.firstLiteral() != max) {
		throw PlatformError("Cast between 64- and 32-bit integer does not work as expected!");
	}
	Antecedent b(max, ~max);
	if (b.type() != Antecedent::Ternary || b.firstLiteral() != max || b.secondLiteral() != ~max) {
		throw PlatformError("Cast between 64- and 32-bit integer does not work as expected!");
	}
	return true;
}
