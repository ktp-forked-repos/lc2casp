...
public:
	...
	SmodelsInput(LpElement& out, const Options& opts, AtomTable* symTab = 0);
...
int readSmodels(std::istream& prg, LpElement& out, ErrorHandler h = 0, const SmodelsInput::Options& opts = SmodelsInput::Options());
 ...
 */
class SmodelsOutput : public LpElement {
public:
