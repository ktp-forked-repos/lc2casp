...
public:
    ...
    Potassco::Id_t addTerm(Potassco::TupleType type, Potassco::IdSpan const& terms);
    Potassco::Id_t addTerm(Value value);
    Potassco::Id_t addElem(Potassco::IdSpan const &tuple, LitVec &&cond);
    std::pair<Potassco::TheoryAtom const &, bool> addAtom(std::function<Potassco::Id_t()> newAtom, Potassco::TheoryAtom::Occurrence occ, Potassco::Id_t termId, Potassco::IdSpan const &elems);
    std::pair<Potassco::TheoryAtom const &, bool> addAtom(std::function<Potassco::Id_t()> newAtom, Potassco::TheoryAtom::Occurrence occ, Potassco::Id_t termId, Potassco::IdSpan const &elems, Potassco::Id_t op, Potassco::Id_t rhs);
...
public:
    using Type = Potassco::Tuple_t::Type;
public:
