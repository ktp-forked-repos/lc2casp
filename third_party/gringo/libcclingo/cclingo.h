...
typedef struct clingo_symbolic_literal_span {
    clingo_symbolic_literal_t const *begin;
    size_t size;
...
enum clingo_ast_type {
    ...
    clingo_ast_type_term_value,
    // TODO: more...
};
typedef int clingo_ast_type_t;
char const *clingo_ast_type_str(clingo_ast_type_t type);
...
typedef clingo_error_t clingo_parse_callback_t (clingo_ast_t*, void *);
typedef clingo_error_t clingo_add_ast_callback_t (clingo_ast_t**, void *);
